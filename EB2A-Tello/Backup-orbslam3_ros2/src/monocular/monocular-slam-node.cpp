...
:   Node("ORB_SLAM3_ROS2")
{
    ...
    m_image_subscriber = this->create_subscription<ImageMsg>("/drone1/image_raw",rclcpp::SystemDefaultsQoS(), std::bind(&MonocularSlamNode::GrabImage, this, std::placeholders::_1));
